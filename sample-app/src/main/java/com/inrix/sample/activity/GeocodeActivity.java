...
import com.inrix.sample.fragments.GeocodeFragment;
import com.inrix.sample.fragments.ReverseGeocodeOnMapFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            tabsAdapter.addTab(actionBar.newTab()
                            .setText(R.string.tab_title_reverse_geocode),
                    ReverseGeocodeOnMapFragment.class,
                    null);

            tabsAdapter.addTab(actionBar.newTab()
                            .setText(R.string.tab_title_geocode),
                    GeocodeFragment.class,
                    null);
        }
    }
}
