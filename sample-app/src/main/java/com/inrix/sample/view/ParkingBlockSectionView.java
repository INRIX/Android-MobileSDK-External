...
public class ParkingBlockSectionView extends LinearLayout {
    @BindView(R.id.parking_block_section_capacity)
    protected TextView capacityText;

    @BindView(R.id.parking_block_section_side)
    protected TextView sideText;

    @BindView(R.id.parking_block_section_zone)
    protected TextView zoneText;

    @BindView(R.id.parking_block_section_pricing_title)
    protected TextView pricingTitleText;

    @BindView(R.id.parking_block_section_pricing_list)
    protected BulletListView pricingList;

    @BindView(R.id.parking_block_section_restrictions_title)
    protected TextView restrrictionsTitleText;

    @BindView(R.id.parking_block_section_restrictions_list)
