...
public class PolylineRouteOverlay {
    ...
    private List<Polyline> generatePolylines(Route route) {
        ...
        for (Bucket b : route.getSpeedBuckets()) {
            ...
            options.addAll(toLatLngList(b.getSpeedBucketPoints()));
     ...
     *
     * @param speedBucketId Speed bucket ID.
     * @return color Color value that corresponds the specified speed bucket.
     */
