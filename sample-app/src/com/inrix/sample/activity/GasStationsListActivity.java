...
public class GasStationsListActivity extends FragmentActivity {
	...
	private final int REQUEST_RADIUS = 2;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int outputOptions = GasStationsRadiusOptions.OUTPUT_FIELDS_BRAND | GasStationsRadiusOptions.OUTPUT_FIELDS_ADDRESS
				            | GasStationsRadiusOptions.OUTPUT_FIELDS_LOCATION | GasStationsRadiusOptions.OUTPUT_FIELDS_CURRENCY_CODE
		...
		InrixCore.getGasStationManager().getGasStationsInRadius(params, new IGasStationResponseListener() {
