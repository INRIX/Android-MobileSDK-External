...
public class ParkingBlockView extends LinearLayout {
    @Bind(R.id.parking_block_title)
    protected TextView title;

    @Bind(R.id.parking_block_description)
    protected ParkingBlockDescriptionView descriptionView;

    @Bind(R.id.parking_block_paystations_list_separator)
    protected View payStationsSeparator;

    @Bind(R.id.parking_block_paystations_list)
    protected ParkingBlockPayStationList payStationsList;

    @Bind(R.id.parking_block_sections_list_separator)
    protected View parkingSectionsSeparator;

    @Bind(R.id.parking_block_sections_list)
