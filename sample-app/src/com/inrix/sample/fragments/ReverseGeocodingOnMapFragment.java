 ...
 */
public class ReverseGeocodingOnMapFragment extends SupportMapFragment implements SearchManager.ISearchResponseListener, OnMapReadyCallback {
    /**
    ...
    private class MapLongClickListener implements OnMapLongClickListener {
        ...
        public void onMapLongClick(LatLng latLng) {
            ...
            searchRequest = searchManager.reverseGeocode(new SearchManager.ReverseGeocodeOptions(GeoPoint.fromLatLng(latLng)), ReverseGeocodingOnMapFragment.this);
        }
    }
}
