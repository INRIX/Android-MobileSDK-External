...
public class SendMockLocationService extends Service implements
	...
	public class UpdateHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			if (!mTestStarted) {
				...
				elapsedTimeNanos = (long) (SystemClock.elapsedRealtime() * 1E6);
				...
				do {
					for (int index = 0; index < mLocationArray.length; index++) {
						...
						if (android.os.Build.VERSION.SDK_INT >= 17) {
							mockLocation
									.setElapsedRealtimeNanos(elapsedTimeNanos);
						}
	...
	public int onStartCommand(Intent startIntent, int flags, int startId) {
		...
		if ( (TextUtils.equals(mTestRequest, LocationUtils.ACTION_START_ONCE))
			...
			mPauseInterval = startIntent
					.getIntExtra(LocationUtils.EXTRA_PAUSE_VALUE, 2);
	...
	public void onConnected(Bundle arg0) {
		...
		TestParam testParams = new TestParam(mTestRequest,
				mPauseInterval,
				mInjectionInterval);
