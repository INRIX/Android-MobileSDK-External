 ...
 * injections. Other Location settings are calculated for each injection, or
...
public class TestLocation {
	 ...
	 * 
	 * @param id
	 *            Identifies this location. Used as the test Location object's
	 *            provider
	 * @param latitude
	 *            The test location's latitude
	 * @param longitude
	 *            The test location's longitude
	 * @param accuracy
	 *            The accuracy of the test location data
	 */
	public TestLocation(String id, double latitude, double longitude,
